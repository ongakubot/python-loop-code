...
async def credits(ctx):
    ...
    await ctx.send('Thanks to `pacmard and simply code and boop` for helping')
...
@client.command(name='hru', help='This command shows how ongaku bot feels')
async def hru(ctx):
    responses = ['**Me?** i am vibing to music!', '**I am sad**, people are not joining with me! **sob sob**', 'Dancing.....**thud** OW! i fell!(i m not that good in dancing) hehe...']
    await ctx.send(choice(responses))
